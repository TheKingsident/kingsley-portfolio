...
const Home = () => {
  return (
    <section
      id="home"
      className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-screen xl:min-h-fit px-4 md:px-8 lg:px-16 py-10 overflow-visible"
    >
      {/* Floating Circles */}
      <FloatingElement 
        className="absolute w-32 h-32 bg-orange-300 rounded-full opacity-50 top-10 left-10"
        delay={0}
      />
      <FloatingElement 
        className="absolute w-24 h-24 bg-blue-300 rounded-full opacity-50 bottom-20 right-20"
        delay={2}
      />
      <FloatingElement 
        className="absolute w-16 h-16 bg-purple-300 rounded-full opacity-50 top-1/3 right-1/2 bg-opacity-25 md:bg-opacity-100"
        delay={1}
      />
      <FloatingElement 
        className="absolute w-20 h-20 bg-pink-300 rounded-full opacity-50 bottom-1/4 left-1/4 bg-opacity-25 md:bg-opacity-100"
        delay={3}
      />

      {/* Content Section */}
      <div className="flex-[2] relative z-20 w-full text-left space-y-6 lg:mt-12 mb-10 md:mb-0">
